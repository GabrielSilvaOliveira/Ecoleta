    ...
    return(
        <SafeAreaView style={{flex: 1}}>
            <View style={styles.container}>
                ...
                <Image style ={styles.pointImage}source={{uri: 'https://images.unsplash.com/photo-1556767576-5ec41e3239ea?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&q=60%22,%22name'}}/>
